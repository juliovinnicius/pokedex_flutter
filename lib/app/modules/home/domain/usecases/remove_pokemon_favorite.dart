...
abstract class IRemoveFavoritePokemonUseCase {
  AsyncResult<PokemonDetailHome, AppException> call(FavoritePokemonDTO dto);
}

class RemoveFavoritePokemonUseCase implements IRemoveFavoritePokemonUseCase {
  final IPokemonsRepository _repository;

  const RemoveFavoritePokemonUseCase(this._repository);

  @override
  AsyncResult<PokemonDetailHome, AppException> call(
      FavoritePokemonDTO dto) async {
    return _repository.removePokemon(dto);
  }
}
